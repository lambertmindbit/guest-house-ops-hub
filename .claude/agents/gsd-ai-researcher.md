...
<required_reading>
Read `/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
