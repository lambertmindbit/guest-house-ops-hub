...
```bash
INIT=$(node "/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
