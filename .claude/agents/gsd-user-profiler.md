...
<reference>
@/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/references/user-profiling.md` to load:
