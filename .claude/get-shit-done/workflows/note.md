...
- **Global scope**: `/Users/lambertshadap/Projects/active/OTA/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/lambertshadap/Projects/active/OTA/.claude/notes/`)
...
2. Glob `/Users/lambertshadap/Projects/active/OTA/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/lambertshadap/Projects/active/OTA/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/lambertshadap/Projects/active/OTA/.claude/notes/` — works in any directory
