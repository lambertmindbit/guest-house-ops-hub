...
```bash
INIT=$(node "/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/templates/spec.md.
