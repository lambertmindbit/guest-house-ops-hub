...
const TENANT_MODELS = new Set<string>([
  ...
  "Staff", "Shift", "Attendance", "HousekeepingTask", "Asset", "MaintenanceRequest", "InventoryItem", "StockMovement", "Vendor", "PurchaseOrder", "VendorPayment", "Driver", "Trip", "BookingGroup", "Amenity", "RoomTypeAmenity",
]);
