...
```
Agent(
  prompt="Read /Users/lambertshadap/Projects/active/OTA/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/templates/VALIDATION.md`
