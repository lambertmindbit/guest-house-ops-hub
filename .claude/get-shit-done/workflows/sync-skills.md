...
INSTALL_JS_GLOBAL="/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
