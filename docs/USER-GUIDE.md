...
![The bottom tab bar on a phone](img/nav-tabbar.png)

The phone menu's big **+** in the middle = new booking. **More** opens everything else (Finance, Pricing, Inbox, Settings, Help…).

![The More menu](img/more-sheet.png)

![Desktop layout with a left sidebar](img/today-desktop.png)
...
![Today dashboard on a phone](img/today.png)
...
![Calendar grid on a phone](img/calendar.png)
...
![New booking form on a phone](img/new-booking.png)
...
![A booking's detail screen on a phone](img/reservation-detail.png)
...
![Payments panel on a booking](img/payments.png)
...
![Guests list on a phone](img/guests.png)
...
![Housekeeping screen on a phone](img/housekeeping.png)
...
![Inbox screen on a phone](img/inbox.png)
...
![Pricing rate calendar on a phone](img/pricing.png)
...
![Finance screen on a phone](img/finance.png)
...
![Analytics screen on a phone](img/analytics.png)
...
![Conflicts screen on a phone](img/conflicts.png)
...
![Feeds screen on a phone](img/feeds.png)
