...
const PATHS: Record<string, ReactNode> = {
  ...
  box: (<><path d="M21 8 12 3 3 8v8l9 5 9-5V8Z" /><path d="M3.3 7 12 12l8.7-5M12 12v9" /></>),
  truck: (<><path d="M3 6h11v9H3zM14 9h4l3 3v3h-7z" /><circle cx="7" cy="18" r="1.6" /><circle cx="17.5" cy="18" r="1.6" /></>),
  star: (<><path d="m12 3 2.9 5.9 6.1.9-4.5 4.4 1 6.1L12 17.8 6.5 20.3l1-6.1L3 9.8l6.1-.9Z" /></>),
