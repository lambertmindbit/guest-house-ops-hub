...
<required_reading>
@/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/references/ai-frameworks.md
@/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/lambertshadap/Projects/active/OTA/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/lambertshadap/Projects/active/OTA/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/lambertshadap/Projects/active/OTA/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/lambertshadap/Projects/active/OTA/.claude/agents/gsd-eval-planner.md for instructions.
