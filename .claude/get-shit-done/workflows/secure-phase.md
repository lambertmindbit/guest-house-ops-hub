...
```
Agent(
  prompt="Read /Users/lambertshadap/Projects/active/OTA/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/lambertshadap/Projects/active/OTA/.claude/get-shit-done/templates/SECURITY.md`
